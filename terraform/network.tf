...
resource "aws_vpc" "main" {
  ...
  tags = {
    Name = "deploy-stack-vite-example-vpc"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "deploy-stack-vite-example-public-subnet-${count.index + 1}"
  }
}
...
resource "aws_security_group" "alb" {
  name        = "deploy-stack-vite-example-alb-sg"
...
resource "aws_security_group" "ecs_tasks" {
  name        = "deploy-stack-vite-example-ecs-sg"
